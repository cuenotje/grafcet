...
public class MainController extends Application implements Initializable {
	...
	private void openGrafcetBuilder() {
		try {
			primaryStage.setScene(new Scene(ViewLoaderHelper
				.loadView(ViewList.GRAFCET_BUILDER_VIEW)));
		} catch (Exception exception) {
			exception.printStackTrace();
			/** * /
			Dialogs.showErrorDialog(primaryStage, "Ooops, there was an error!",
					"Error Dialog With Exception", "title", exception);
			/**/
		}
	}
